...
interface SimpleWhatsAppPhoneProps {
  value: string
...
export function SimpleWhatsAppPhone({
  value,
  onChange,
  ...
  return (
    <div className="space-y-2">
      ...
      <div className="flex border-2 border-gray-200 rounded-lg overflow-hidden hover:border-orange-300 focus-within:border-orange-500">
        {/* Country Code Dropdown - Right beside the input */}
        <select
          value={countryCode}
          onChange={(e) => handleCountryCodeChange(e.target.value)}
          disabled={disabled}
          className="bg-gray-50 border-r border-gray-200 px-3 py-3 text-sm font-mono focus:outline-none focus:bg-white min-w-[80px]"
        >
